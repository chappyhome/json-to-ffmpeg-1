...
color=black@0.0:s=1920x1080:d=10[HNzcGbYx_base];
[0:v]scale=1920:1080,format=rgba,colorchannelmixer=aa=1[3Xxl4pDw_clip];
[HNzcGbYx_base][3Xxl4pDw_clip]overlay=0:0:format=auto,rotate=0,fps=30[video_clip];
